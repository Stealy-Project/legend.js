...
class User {
  ...
  setup(data) {
    ...
    this.lastMessage = null;
     ...
     /**
       ...
       */
      this.clan = {
        identityGuildId: data.clan?.identity_guild_id ?? null,
        identityEnabled: data.clan?.identity_enabled ?? null,
  ...
  patch(data) {
    for (const prop of ['id', 'username', 'discriminator', 'avatar', 'bot', 'global_name']) {
  ...
  fetchProfile(guild) {
    ...
    return this.client.rest.methods.fetchUserProfile(this, guild);
  }
