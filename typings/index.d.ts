// Type definitions for legend.js 11.8.9
// Definitions by:
...
declare module 'legend.js' {
	...
	export class Client extends EventEmitter {
		...
		public on(event: 'relationshipAdd', listener: (id: Snowflake, type: RelationshipType) => void): this;
		...
		public once(event: 'relationshipAdd', listener: (id: Snowflake, type: RelationshipType) => void): this;
	...
	export class ClientUser extends User {
		...
		public setCustomStatus(status: CustomStatus): Promise<ClientUser>;
		...
		public setPresence2(data: PresenceData2): Promise<ClientUser>;
	...
	export class Guild {
		...
		public disableEveryone(allow: boolean): Promise<Guild>;
		public disableRoles(allow: boolean): Promise<Guild>;
		public mute(allow: boolean): Promise<Guild>;
	...
	export class User extends PartialTextBasedChannel() {
		...
		public avatarDecorationSKUId: Snowflake;
		public readonly avatarURL: string;
		public readonly avatarDecorationURL: string;
		public bot: boolean;
		public readonly client: Client;
		public readonly createdAt: Date;
		public readonly createdTimestamp: number;
